...
# Prevents   "delois@Jims-MacBook-Pro" from showing up on the local in this theme
## See also: prompt_context, below, which overwrites this "blankness"
# DEFAULT_USER="delois"

# Context: user@hostname (who am I and where am I)
## CUSTOMIZATION: Get rid of username. Add fun emoji instead.
prompt_context(){
  prompt_segment black default "👀"
}

# Dir: current working directory
## CUSTOMIZATION: Limit dir listing to two folders
## - Let us display two (2) levels deep on the DIR in the prompt
## - See: https://github.com/ohmyzsh/ohmyzsh/issues/9614#issuecomment-765468880
prompt_dir() {
